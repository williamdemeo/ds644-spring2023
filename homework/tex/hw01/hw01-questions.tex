...
Some of the questions will have more than one correct choice.

\begin{center}
  \textbf{\textit{Select all correct choices to receive full credit!}}
\end{center}
...
\part To what does the expression \texttt{list.flatMap(sq)} evaluate?
  ...
  % Question 6
  \question[4] \textbf{Introduction to Scala, Part II}. The parts below refer to the function \texttt{test(x:Int, y:Int) = x * x}.
