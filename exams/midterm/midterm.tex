\input{./exams/midterm/header.tex}

\begin{document}


\noindent {\bf \coursename : \semester}\hfill {\bf Midterm Examination} \hfill \ifanswers {\bf ANSWERS}
\else {\bf Section \sectionnumber}
...
\underline{\phantom{x} 29 March 2023 \phantom{x}}}
...
\input{./exams/midterm/midterm-questions}

\newpage

\ifanswers
\else
 \begin{center} scratch work  \end{center}
\fi
