...
\end{comment}
  ...
  \includegraphics[scale=.3]{exams/midterm/figures/IntSet.png}

  \includegraphics[scale=.3]{exams/midterm/figures/Empty.png}

  \includegraphics[scale=.3]{exams/midterm/figures/NonEmpty.png}
